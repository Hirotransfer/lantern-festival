...
function show_runtime() {
    var newDay = '2023/02/05 00:00:00';
...
function newyear() {
    document.getElementById('title').innerText = 'Happy Lantern Festival';
    document.getElementById('day').innerText = '元';
    document.getElementById('hour').innerText = '宵';
